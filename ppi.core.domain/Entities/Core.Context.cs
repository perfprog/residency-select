...
namespace PPI.Core.Domain.Entities
{
    ...
    public partial class CoreContainer : DbContext
    {
        ...
        public virtual ObjectResult<GetPracticeScaleParagraphText_Result> GetPracticeScaleParagraphText(string hoganId, Nullable<int> language, Nullable<int> report)
        {
            var hoganIdParameter = hoganId != null ?
                new ObjectParameter("HoganId", hoganId) :
                new ObjectParameter("HoganId", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetPracticeScaleParagraphText_Result>("GetPracticeScaleParagraphText", hoganIdParameter, languageParameter, reportParameter);
        }
        ...
        public virtual int ClonePracticeScaleReport(Nullable<int> practiceScaleReportId, Nullable<int> orginalProgramId, Nullable<int> newProgramId, Nullable<bool> newText)
        {
            var practiceScaleReportIdParameter = practiceScaleReportId.HasValue ?
                new ObjectParameter("PracticeScaleReportId", practiceScaleReportId) :
                new ObjectParameter("PracticeScaleReportId", typeof(int));
    
            var orginalProgramIdParameter = orginalProgramId.HasValue ?
                new ObjectParameter("OrginalProgramId", orginalProgramId) :
                new ObjectParameter("OrginalProgramId", typeof(int));
    
            var newProgramIdParameter = newProgramId.HasValue ?
                new ObjectParameter("NewProgramId", newProgramId) :
                new ObjectParameter("NewProgramId", typeof(int));
    
            var newTextParameter = newText.HasValue ?
                new ObjectParameter("NewText", newText) :
                new ObjectParameter("NewText", typeof(bool));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ClonePracticeScaleReport", practiceScaleReportIdParameter, orginalProgramIdParameter, newProgramIdParameter, newTextParameter);
        }
    }
}
